            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="space-y-6">
                    <p class="text-lg text-gray-300 leading-relaxed">
                        Saya seorang Full-Stack Developer dengan pengalaman 5+ tahun dalam membuat aplikasi web yang
                    ...
                    <div class="bg-dark-tertiary rounded-2xl p-8 text-white space-y-4 shadow-xl border border-gray-800/50">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between items-center pb-2 border-b border-gray-700">
                                ...
                                <span class="font-semibold">3 Year</span>
                            </div>
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10">
                            ...
                            <div
                                ...
                                <div class="h-48 relative overflow-hidden flex-shrink-0">
                                    ...
                                    <div class="absolute top-4 right-4">
                                        <div
                                            class="bg-black/40 backdrop-blur-sm rounded-full px-3 py-1 border border-white/10">
                                ...
                                <div class="p-6 flex-grow flex flex-col">
                                    <h3
                                        class="text-xl font-semibold text-white mb-2 group-hover:text-navy-300 transition-colors">
                                        {{ $project->title }}
                                    </h3>
                                    ...
                                    <div class="flex flex-wrap gap-2 mb-4">
                                        @foreach ($project->tags as $tag)
                                            <span
                                                class="px-3 py-1 bg-gray-800 text-gray-300 rounded-full text-sm font-medium border border-gray-700">
                                                {{ $tag }}
                                            </span>
                                        @endforeach
                                    </div>
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <div class="text-gray-500">Projek unggulan akan muncul di sini setelah ditambahkan melalui admin panel.
                    </div>
                </div>
            @endif
        ...
        <div class="max-w-7xl mx-auto px-6 relative z-10">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-300 max-w-2xl mx-auto">
                    Tools dan teknologi yang saya gunakan untuk mewujudkan ide
                </p>
                <div class="w-20 h-1 bg-navy-500 mx-auto rounded-full mt-4"></div>
            </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                @foreach ($skills as $skill)
                    <div
                        class="group p-6 bg-dark-tertiary rounded-xl
                        ...
                        <div class="text-center">
                            <div
                                class="w-12 h-12 mx-auto mb-3 rounded-lg bg-gray-800
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center space-x-4 p-4 bg-dark-tertiary rounded-xl border border-gray-800/50">
                            <div
                                ...
                                <svg class="w-6 h-6 text-navy-400" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                </svg>
